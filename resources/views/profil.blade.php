          ...
          <div class="row">
            ...
            <hr style="margin-top: 0px;">
              <div class="row" style="margin-bottom: 5px;">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="nama2" name="nama2" style="width:100%;border:none;" value="{{Auth::user()->name}}" required>     
                </div>
              </div>
              <div class="row" style="margin-bottom: 5px;">
                <label for="alamat2" class="col-sm-2 control-label">Alamat</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="alamat2" name="alamat2" style="width:100%;border:none;" value="{{Auth::user()->alamat}}" required>     
                </div>
              </div>
              <div class="row" style="margin-bottom: 5px;">
                <label for="email2" class="col-sm-2 control-label">Email</label>
                <div class="col-sm-10">
                  <input type="email" class="form-control" id="email2" name="email2" style="width:100%;border:none;" value="{{Auth::user()->email}}" required>     
                </div>
              </div>
              <div class="row" style="margin-bottom: 5px;">
              ...
              <div class="row" style="margin-bottom: 5px;">
                <label for="no_hp2" class="col-sm-2 control-label">BBM</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="bbm2" name="bbm2" style="width:100%;border:none;" value="{{Auth::user()->bbm}}" required>     
                </div>
              </div>
              <div class="row" style="margin-bottom: 5px;">
