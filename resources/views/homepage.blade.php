            ...
            <tr>
              <td>
                ...
                <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3">
                  <div class="row">
                    <input type="text" name="nama" style="border:none;width:100%;height:30px" placeholder="Cari Produk">               
                  </div>           
                </div>
                <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3">
                  <select name="provinsi" style="border:none;width:100%;height:30px">
                ...
                <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3">
                  <select name="kategori" style="border:none;width:100%;height:30px">
                ...
                <div class="col-md-2 col-sm-2 col-lg-2 col-xs-2" style="padding-right:0px;">
                  <button  name="submit" class="btn btn-success" style="width:100%;">
                    <span class="fa fa-search"></span>
                  </button>                
                </div>
              </td>
